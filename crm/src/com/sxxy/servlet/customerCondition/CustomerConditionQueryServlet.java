...
public class CustomerConditionQueryServlet extends HttpServlet {
	 ...
	 */
	public CustomerConditionQueryServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<CustomerConditionInfo>  list=  service.query(ConditionName) ;
		request.setAttribute("list", list);
		
		request.getRequestDispatcher("/view/customerCondition/customerCondition_list.jsp").forward(request, response);
	}
