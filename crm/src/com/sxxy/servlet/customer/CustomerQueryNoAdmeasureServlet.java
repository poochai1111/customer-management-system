...
public class CustomerQueryNoAdmeasureServlet extends HttpServlet {
	 ...
	 */
	public CustomerQueryNoAdmeasureServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<CustomerInfo> list=  service.getNoAdmeasure();
		
		
		request.setAttribute("list", list);
		request.getRequestDispatcher("/view/customer/customer_admeasure.jsp").forward(request, response);
	}
