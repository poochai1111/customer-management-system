...
public class CustomerSourceDeleteServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public CustomerSourceDeleteServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		boolean mark =   service.delete(sourceId);
		
		if (mark) {
			request.setAttribute("info", "客户来源删除成功");
		}else{
			request.setAttribute("info", "客户来源删除失败");
		}
