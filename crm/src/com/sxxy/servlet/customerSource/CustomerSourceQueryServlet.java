...
public class CustomerSourceQueryServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public CustomerSourceQueryServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<CustomerSourceInfo>  list=  service.query(SourceName) ;
		request.setAttribute("list", list);
		
		request.getRequestDispatcher("/view/customerSource/customerSource_list.jsp").forward(request, response);
	}
