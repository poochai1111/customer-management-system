...
public class EmailQueryServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		EmailService service = new  EmailServiceImpl();
		 ...
		 List<EmailInfo>  emailList = service.getAllEmail(null, null);
		 
		 request.setAttribute("emailList", emailList);
		 
		 
		 
		 request.getRequestDispatcher("/view/email/email_outbox.jsp").forward(request, response);
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//根据条件查询用户信息
		List<EmailInfo> list = service.getAllEmail(emailInput,queryType);
