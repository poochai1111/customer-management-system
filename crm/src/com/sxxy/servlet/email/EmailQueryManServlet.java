...
public class EmailQueryManServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public EmailQueryManServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/view/email/email_add.jsp").forward(request, response);
	}
