...
public class CustomerTypeQueryServlet extends HttpServlet {
	 ...
	 */
	public CustomerTypeQueryServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<CustomerTypeInfo>  list=  service.query(TypeName) ;
		request.setAttribute("list", list);
		
		request.getRequestDispatcher("/view/customerType/customerType_list.jsp").forward(request, response);
	}
