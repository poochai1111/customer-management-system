...
<td class=editHeaderTd colSpan=7>  请分配客户
    	...
    	<%List <CustomerInfo> customerList =(List <CustomerInfo>) request.getAttribute("customerInfo"); %>
				<%for ( int i=0;i<customerList.size();i++){
											CustomerInfo customerInfo =customerList.get(i);
			%>
	<tr>
    		<td width="19%" bgcolor="#FFFDF0"><div align="center">客户<%=i+1 %>：</div></td>
    			<td colspan="3" bgcolor="#FFFFFF"><input type="text"  style=" width: 145px" name="customerName"  disabled="disabled"  value="<%=customerInfo.getCustomerName() %>"   >
      			<input type="hidden" name="customerId" value="<%=customerInfo.getCustomerId()%>" />
     		 </td>
     	 </tr>  	 
     	 <% }%>
  <tr>
